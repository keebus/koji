...
kj_internal void report(issue_handler_t *e, source_location_t sl, const char *format, ...)
{
	va_list args;
...
kj_internal void error(issue_handler_t *e, source_location_t sl, const char *format, ...)
{
	va_list args;
	va_start(args, format);
	reportv(e, sl, format, args);
