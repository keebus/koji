...
#ifdef KOJI_X64
   typedef unsigned long long kj_size_t;
#else
   typedef unsigned int kj_size_t;
#endif

/*
 * The 64-bit floating point type used by koji to represent numeric values.
 */
typedef double kj_number_t;
 ...
 */
typedef void * (*kj_malloc_fn_t)  (void *userdata, kj_size_t size, kj_size_t alignment);
typedef void * (*kj_realloc_fn_t) (void *userdata, void *ptr, kj_size_t size, kj_size_t alignment);
typedef void   (*kj_free_fn_t)    (void *userdata, void *ptr);
 ...
 */
typedef int (*kj_stream_read_t) (void* userdata);
 ...
 */
typedef struct kj_state kj_state_t;
 ...
 */
KOJI_API
kj_state_t * kj_open(kj_malloc_fn_t malloc_fn, kj_realloc_fn_t realloc_fn, kj_free_fn_t free_fn, void *alloc_userdata);

/*
 * #todo
 */
KOJI_API
kj_result_t kj_load(kj_state_t *, const char *source_name, kj_stream_read_t stream_read_fn, void *stream_read_data);
