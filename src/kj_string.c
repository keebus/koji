...
static union class_operator_result string_operator_add(struct vm* vm, struct class* class, struct object* object, enum class_operator_kind op, value_t arg)
{
	...
	return class_operator_invalid(vm, class, object, op, arg);
}

static union class_operator_result string_operator_mul(struct vm* vm, struct class* class, struct object* object, enum class_operator_kind op, value_t arg)
{
	struct string* lhs_string = (struct string*)object;

	if (!value_is_number(arg)) {
		class_operator_invalid(vm, class, object, op, arg);
...
static union class_operator_result string_operator_compare(struct vm* vm, struct class* class, struct object* object, enum class_operator_kind op, value_t arg)
{
	struct string* lhs_string = (struct string*)object;
	struct object* rhs_object = value_get_object(arg);
	struct string* rhs_string = (struct string*)rhs_object;
	...
	return class_operator_compare_default(vm, class, object, op, arg);
}

static union class_operator_result string_operator_hash(struct vm* vm, struct class* class, struct object* object, enum class_operator_kind op, value_t arg)
{
	struct string* lhs_string = (struct string*)object;
